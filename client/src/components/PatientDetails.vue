            ...
            <tr>
              <td>
                ...
                <div v-if="editMode" class="
                  ...
                  ">
                  Patient:
                  <input class="text-center" type="text" v-model="currentPatientID" />
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                ...
                <div v-if="editMode" class="
                  ...
                  ">
                  Weight (kg):
                  <input class="text-center" type="text" v-model="patient.Weight" />
                </div>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <div v-if="editMode" class="
                  ...
                  ">
                  Height (cm):
                  <input class="text-center" type="text" v-model="patient.Height" />
                </div>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <div v-if="editMode" class="
                  ...
                  ">
                  Age:
                  <input class="text-center" type="text" v-model="patient.Age" />
                </div>
              </td>
            </tr>
          </tbody>
        </table>
        <div v-if="!editMode" class="d-flex justify-content-between align-items-baseline">
