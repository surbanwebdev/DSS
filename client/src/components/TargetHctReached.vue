    ...
    <div class="container mt-5">
      ...
      <div class="card p-3">
        <div class="title-wrap d-flex align-items-center mb-4">
          ...
          <h5 class="blue-heading m-0">Target Hct Treatment</h5>
        </div>
        <p class="bold-heading mb-1">Has Target Hematocrit been reached?</p>
        <ul>
          <li>This will be calculated by the software.</li>
        </ul>
